...
/// <summary>
/// Provides context for intercepting asynchronous void methods.
/// </summary>
...
internal class AsyncInterceptorContext<TInterface, TImplementation>(
    ...
    Func<Task> implementationRunner)
    ...
    where TImplementation : class, TInterface
{
    ...
    /// </summary>
    /// <exception cref="NotImplementedException">Always thrown as this is not supported for asynchronous methods.</exception>
    public void Proceed()
    {
...
/// <summary>
/// Provides context for intercepting asynchronous methods with return values.
/// </summary>
/// <typeparam name="TInterface">The interface type being intercepted.</typeparam>
/// <typeparam name="TImplementation">The implementation type of the interface.</typeparam>
...
internal class AsyncInterceptorContext<TInterface, TImplementation, TResult>(
    IReadOnlyList<IInterceptor<TInterface, TImplementation>> interceptors,
    TImplementation implementation,
    MethodInfo interfaceMethodInfo,
    MethodInfo implementationMethodInfo,
    IReadOnlyList<object?> parameters,
    Func<Task<TResult>> implementationRunner)
    : IInterceptorContext<TInterface, TImplementation>
    where TImplementation : class, TInterface
{
    private int runningIndex = -1;
