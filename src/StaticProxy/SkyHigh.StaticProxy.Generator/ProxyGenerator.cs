...
namespace SkyHigh.StaticProxy.Generator
{
    ...
    public class ProxyGenerator : IIncrementalGenerator
    {
        ...
        private static void GenerateProxyClass(SourceProductionContext context, ITypeSymbol interfaceType, ITypeSymbol implementationType)
        {
            ...
            var generatorFullName = typeof(ProxyGenerator).FullName ?? "SkyHigh.StaticProxy.Generator.ProxyGenerator";

            sb.AppendLine("// <auto-generated>");
            sb.AppendLine("// This code was generated by the " + generatorFullName);
            sb.AppendLine("// Compile Time : " + DateTimeOffset.Now.ToString("O"));
            sb.AppendLine("// </auto-generated>");
            ...
            sb.AppendLine($"  [System.CodeDom.Compiler.GeneratedCodeAttribute(\"{generatorFullName}\", \"{typeof(ProxyGenerator).Assembly.GetName().Version}\")]");
